...
project = u'Research Skills for Physics' # e.g. How To Think Like a Computer Scientist
...
html_theme_options = {
    ...
    'navbar_title': "Research Skills for Physics",
...
html_title = 'Research Skills for Physics'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Research Skills'

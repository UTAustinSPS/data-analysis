...
project = u'Introduction to Data Analysis for Physics' # e.g. How To Think Like a Computer Scientist
copyright = u'2013, University of Texas at Austin Society of Physics Students and Sigma Pi Sigma' # e.g. "2013, Brad Miller and David Ranum"
...
html_theme_options = {
    ...
    'navbar_title': "Introduction to Data Analysis for Physics",
...
html_title = 'Introduction to Data Analysis for Physics'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Physics Data Analysis'
